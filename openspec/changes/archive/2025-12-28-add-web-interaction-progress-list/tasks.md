## 1. Implementation
- [x] 1.1 Extend the interaction/session model to capture interface type, started time, and status states (pending, submitted, auto-submitted, cancelled, timeout) for both terminal and web flows.
