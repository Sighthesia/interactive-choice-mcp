...
2. Specify terminal UI requirements: timestamp + timeout display, j/k navigation, Tab to annotations, always-on annotations, cancel → global annotation, settings entry, transport switch behavior.
