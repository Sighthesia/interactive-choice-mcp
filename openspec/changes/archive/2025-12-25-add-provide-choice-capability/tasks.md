...
- [x] 1.2 Add orchestration that selects terminal-first interface with web portal fallback, injecting task context into prompts and disallowing speculative defaults.
