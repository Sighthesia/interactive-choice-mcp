...
## What Changes
- Split the web portal into modular assets (CSS, JS, markup fragments) grouped by concern (layout, interaction list, timeout, config/i18n, transport state) with a lightweight assembly step.
